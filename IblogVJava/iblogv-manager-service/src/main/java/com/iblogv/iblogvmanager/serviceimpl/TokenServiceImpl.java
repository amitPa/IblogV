...
import com.iblogv.iblogvmanager.service.TokenService;
...
public class TokenServiceImpl implements TokenService {
	...
	@Override
	public ResponseCode validateAccessToken(String token) throws IblogvException {
		if (validateToken(token))
			return new ResponseCode("200", "Token Valid");
		return new ResponseCode("400", "Token Invalid");
	}
	...
	public Boolean validateToken(String token) {
		...
		UserEntity userEntity=userJpaRepository.authUser(username);
